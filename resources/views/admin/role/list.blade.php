                ...
                <div class="layui-col-md12">
                    <div class="layui-card">
                        <div class="layui-card-body ">
                            <form class="layui-form layui-col-space5" method="get" action="/admin/role">
                                ...
                                <div class="layui-inline layui-show-xs-block">
                                    <input type="text" name="name" value="{{$request->input('role_name')}}" placeholder="请输入用户名" autocomplete="off" class="layui-input">
                                ...
                                <tr>
                                 ...
                                 <!--  <td>会员列表，问题列表</td>
                                  ...
                                  <td class="td-manage">
                                    ...
                                    <a title="操作权限"  onclick="xadmin.open('权限','/admin/role/auth/{{$v->id}}')" href="javascript:;">
                                      <i class="layui-icon">&#xe646;</i>
                                    </a>
