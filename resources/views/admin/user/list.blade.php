...
<html class="x-admin-sm">
                ...
                <div class="layui-col-md12">
                    <div class="layui-card">
                        <div class="layui-card-body ">
                            <form class="layui-form layui-col-space5" method="get" action="/admin/user">
                        ...
                        <div class="layui-card-header">
                            ...
                            <button class="layui-btn" onclick="xadmin.open('添加用户','user/create',600,400)"><i class="layui-icon"></i>添加</button>
                        </div>
                        <div class="layui-card-body ">
    ...
    <script>
      ...
      function delAll (argument) {
        ...
        layer.confirm('确认要删除吗？',function(index){
            //捉到所有被选中的，发异步进行删除
            $.post('/admin/user/delall',{'ids':ids,'_token':'{{csrf_token()}}'},function(data)
            {
              if(data.status==1)
            {
              // alert(2222)
